---
title: "Art Appreciation · S1 A4: The Unit 4 Synthesis"
related:
...
[[classes/art-appreciation/art-appreciation|Art Appreciation]] · [[classes/art-appreciation/assessments/art-appreciation-s1-assessments|S1 Assessment Register]] · [[classes/art-appreciation/lesson-plans/art-appreciation-s1-lesson-12-photography-and-after|Lesson 12]] · Attainment 4 of 4

## At a glance

| | |
|---|---|
| Sits | Tue 2026-12-15, the Tuesday double |
| Category | Attainment, the last of four in the 50% category |
...
| Note | **This is the last work you submit this semester.** It clears the late-work cutoff by a fortnight |
...
1. **Work from the whole unit**, not from the last week of it.
2. **Build the constellation.** Adjacency is the argument, as it was at A1: each pairing needs a reason that could not be moved elsewhere.
3. **Include something you disagree with**, or something that resists your reading. A constellation that meets no resistance is usually not arguing.
...
|---|---|---|---|---|
| **Perceptive** | Every pairing carries a reason belonging to that pair alone. At least one adjacency puts two positions in genuine tension and holds them there | The claim is visible on arrival. Distance, grouping and gaps all doing work, more confidently than at A1 | The whole unit is in play, including positions that disagree and material you would not have chosen on preference | Argues rather than narrates. Names the tension, names what is excluded, and does not resolve what the unit left unresolved |
| **Convincing** | Reasons are specific to their pairs, with one or two transferable | The argument reads clearly with a moment's looking | Good coverage of the unit, with one strand under-represented | A clear argument with reasons throughout |
| **Competent** | Pairings are related, with true but general reasons | An order is visible; the claim needs a sentence of help | Covers the material taught most recently, or the most congenial half of the unit | States the claim and supports most of it |
...
- **Review is in lesson, on day six.** This is the only in-lesson review this term, and it works because the work is still live and still on the wall.
