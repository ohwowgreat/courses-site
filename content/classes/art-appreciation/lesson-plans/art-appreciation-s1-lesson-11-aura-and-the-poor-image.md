...
1. Define aura precisely enough to disagree with Benjamin about it
2. Defend a low-resolution image as having value of its own, not merely as a compromise
3. Degrade an image deliberately and describe exactly what changed, not that it got worse

## How it runs

- **Day 1 · Mon 7 Dec · `U4·L8`** — ukiyo-e: a print is many, not one; the market that made them. Benjamin set.
...
- **Day 2 · Tue 8 Dec · `U4·L9`** — aura, defined precisely enough to argue with Benjamin about it — then argue with it.
...
- **Day 4 · Thu 10 Dec · `U4·L11`** — the poor-image lab: degrade, compress, re-photograph, screenshot the screenshot; then fifteen minutes writing exactly what changed. CS5 collected. This is the practice for A4.
