...
The question here is what makes something art when looking cannot settle it. **Danto** answers by pointing past the object itself. His idea of **the artworld** is that an object counts as art because of the institution and ideas around it, not because of how it looks. This leads to what he calls **the end of art**: once anything can be art, appearance alone no longer decides. This lesson takes the argument straight.
...
- Say what makes something art when looking cannot settle it.
- Explain **Danto**'s idea of **the artworld** and **the end of art**.
- Follow an object out of the studio and into the institution, and name who decided.
- Use **Duchamp** and **Warhol** to explain **pluralism**.
