...
1. Say why we believe photographs, and whether we should
2. Test Greenberg's line and find the place where it stops holding, rather than simply agreeing with it
3. Build a constellation that argues across the whole unit, not just a selection of favorites
...
The synthesis is on day five, with feedback on day six. A4 is the last thing you submit this semester, and nothing in this unit can be handed in late. This is the second constellation of the year; the Unit 1 boards go back up on day four so you can compare.

## How it runs

- **Day 1 · Fri 11 Dec · `U4·L12`** — what the poor image gains: what circulation gives that quality takes. (This day falls on Foreign Culture Day.)
- **Day 2 · Mon 14 Dec · `U4·L13`** — photography and the claim to truth: why we believe photographs, and whether we should. Sontag set.
- **Day 3 · Tue 15 Dec · `U4·L14`** — Sontag: photographing as an act on the world.
- **Day 4 · Wed 16 Dec · `U4·L15`** — avant-garde and kitsch: test Greenberg's line and find the place where it stops holding. Unit 1 boards back on the wall.
- **Day 5 · Thu 17 Dec · `U4·L16`** — **A4 sitting**: build the constellation and write the argument, 40 minutes.
- **Day 6 · Fri 18 Dec · `U4·L17`** — synthesis debrief: work returned with the criteria, focusing on the one move that would have sharpened it.

## Assessment

- **A4: Unit 4 synthesis constellation**, marked on how well you argue across the whole unit, not just a selection of favorites. The sitting day will be confirmed in class.
- Review is in-lesson on day six — the only in-lesson review this term.
