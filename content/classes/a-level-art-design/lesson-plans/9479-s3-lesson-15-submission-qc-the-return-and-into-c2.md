...
Your complete investigation is returned and reviewed one to one. You then do supervised gap repair: you fix anything QC flagged.

### The End of Term

The **End of Term** is met by **the Final**, not a sit-down exam. The Final is a teacher-marked assessment of your portfolio against the Cambridge criteria. There is no paper and no invigilation. This class sits no department finals, so the January window is free for marking. The Final meets the 20% End-of-Term category. See the [[classes/a-level-art-design/assessments/9479-s3-assessments|register]].
...
- Assemble the PDF submission to the Cambridge screen limits and pass it through submission QC.
