...
**CS2** (statement of intent + annotated references) is due **Fri 2027-03-12**, a written annotation that consolidates the locked theme into recordable foundations — see the [[classes/a-level-art-design/assessments/9479-s2-assessments|full register]]. The theme lock on Monday is the unit's real gate: it carries no mark, but it is signed, and there are no restarts after it. Unit 2 opens next week, and your first attainment — **A1**, the recording milestone marked against AO1 — is on **Fri 2027-03-19** in [[classes/a-level-art-design/lesson-plans/9479-s2-lesson-04-recording-and-the-a1-milestone|L04]].

These 2027 dates may shift when the school publishes the calendar for that period.
