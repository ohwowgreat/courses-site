---
title: "9479 S1 Lesson 05: Recording Pages and A1"
...
# 9479 S1 Lesson 05: Recording Pages and A1

[[classes/a-level-art-design/a-level-art-design|A Level Art & Design]] · [[classes/a-level-art-design/unit-plans/9479-s1-unit-2-recording-and-sustained-study|Unit 2]] · Lesson 05 of 15 · ← [[classes/a-level-art-design/lesson-plans/9479-s1-lesson-04-the-sustained-study|L04]] | [[classes/a-level-art-design/lesson-plans/9479-s1-lesson-06-media-exploration|L06]] →

## At a glance

| | |
|---|---|
| Sessions | 6 days (W5–W6, split by National Day) — Unit 2 closes; first use of the attainment review protocol |
...
Everything recorded so far becomes pages an examiner could read, then is looked at together. The holiday splits the lesson deliberately: pages are built before it, the review happens after it, and the self-check on return closes the gap between what students think AO1 asks and what it asks.
...
- **Sat 10-10** (make-up day) — A1 returned with banded feedback; feedback converted into three specific written actions, one-to-one rota; Unit 3 preview.

## Assessment

**CS4** (recording pages build check) Wed 2026-09-30. **A1** (recording milestone, marked against AO1) Fri 2026-10-09 — see the [[classes/a-level-art-design/assessments/9479-s1-assessments|full register]]. The self-check target: the student's own banding lands within one band of the teacher's.
