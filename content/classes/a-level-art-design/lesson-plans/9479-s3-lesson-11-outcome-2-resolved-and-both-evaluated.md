...
**Same standard.** Both outcomes are resolved and photographed to the same standard. An unequal pair reads as one finished piece and one draft, so give outcome 2 the same finish and care as outcome 1.
