---
title: "S4 Lesson 04: Exploration and Artist 1"
related:
...
<span class="pb-pos"><span class="pb-segs" aria-hidden="true"><i class="pb-seg pb-seg--now"></i><i class="pb-seg"></i></span><span class="pb-label">Lesson 1 of 2 in this unit · L04 of 10</span><a class="pb-arrow" href="../../../classes/a-level-art-design/lesson-plans/9479-s4-lesson-03-sustained-study-and-a1" aria-label="Previous: Lesson 03"><svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M10 3 5 8l5 5"></path></svg></a><a class="pb-arrow" href="../../../classes/a-level-art-design/lesson-plans/9479-s4-lesson-05-artist-2-the-bridge-piece-and-a2" aria-label="Next: Lesson 05"><svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m6 3 5 5-5 5"></path></svg></a></span>
</div>


<div class="contract">
<div class="contract-head"><span class="contract-kicker">Your job this lesson</span><span class="contract-aos"><span class="contract-ao">AO2 Explore</span><span class="contract-ao">opening into AO3 Develop</span></span></div>
<p class="contract-job">Eight experiments run to a written keep-or-change decision; artist 1 analyzed and answered in visible work</p>
<div class="contract-grid">
<div class="contract-cell"><span class="contract-cell-label">When</span><span class="contract-cell-value">Mon 2028-03-13 → Fri 2028-03-17 <em>(projected)</em><span class="contract-cell-note">Sessions: 5 days (S4)</span></span></div>
</div>
<div class="contract-foot"><span class="contract-hw"><span class="contract-line-label">Homework</span> ≤30 min: write the keep-or-change line for two experiments — what carries the question, what doesn't</span></div>
<div class="contract-more">
<span class="contract-line"><span class="contract-line-label">Graded</span> <strong><a href="../../../classes/a-level-art-design/assessments/9479-s4-assessments">CS4</a></strong> Fri 2028-03-17 (experiment documentation + artist 1 response). Fri 2028-03-17. No attainment this week</span>
</div>
</div>
...
You run **eight experiments** this week. This is a compressed set, cut down from the twelve you ran in C3, and drawn from selections you have already proven. Each experiment tests your question, not the medium for its own sake.

Each experiment ends in a **written keep-or-change decision**: you state in writing what carries the question and what does not. This keeps exploration focused, so it feeds development rather than sprawling.

Your media choices carry conceptual logic even at exam pace. Each of the eight experiments has a reason.
...
- Turn A1 feedback into working targets.
- Run eight experiments, each with a reason tied to your question.
...
<div class="page-nav">
<a class="page-nav-prev" href="../../../classes/a-level-art-design/lesson-plans/9479-s4-lesson-03-sustained-study-and-a1">← Lesson 03 · Sustained Study and A1</a>
<a class="page-nav-next" href="../../../classes/a-level-art-design/lesson-plans/9479-s4-lesson-05-artist-2-the-bridge-piece-and-a2">Lesson 05 · Artist 2, the Bridge Piece, and A2 →</a>
</div>
