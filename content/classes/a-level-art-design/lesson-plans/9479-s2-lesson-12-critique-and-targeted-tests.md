...
[[classes/a-level-art-design/a-level-art-design|A Level Art & Design]] · [[classes/a-level-art-design/unit-plans/9479-s2-unit-4-development|Unit 4]] · Lesson 12 of 15 · ← [[classes/a-level-art-design/lesson-plans/9479-s2-lesson-11-composition-2-and-paper-drafts|L11]] | [[classes/a-level-art-design/lesson-plans/9479-s2-lesson-13-evaluation-draft-1-and-a3|L13]] →
...
- **Tue 05-18 — act on the critique.** Change something because of what you heard. A critique you nod at and ignore is worthless; the mark is in the response.
- **Wed 05-19 — targeted tests, day 1.** Test **only what is unresolved** — the specific passages the critique flagged. Not a fresh round of exploration; surgical tests on named problems.
- **Thu 05-20 — targeted tests, day 2.** Finish the tests and read the results into the decision. What did the tests settle?
- **Fri 05-21 — choose the final direction + CS8.** Choose which composition carries into the mid-point piece, and **write the rejection**: why not the other one. CS8 collects the targeted tests and your critique response — the evidence behind the choice.
