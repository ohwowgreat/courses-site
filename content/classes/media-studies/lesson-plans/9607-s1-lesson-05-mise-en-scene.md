...
<p class="handouts"><strong>Lesson slides:</strong> <a href="../../../decks/media-studies/media-studies-s1-lesson-05-mise-en-scene.pptx">Download the deck (PowerPoint, 702 KB)</a> · <a href="../../../decks/credits">image credits</a></p>
...
The full element list is on the [[concepts/technical-elements|technical elements]] page.

**1.** Name the four things the syllabus files under production design.

<details class="reveal"><summary>Show answer</summary>

Location and studio, set design, costume and make-up, properties. Lighting and colour design sit alongside them under mise-en-scène.

</details>

**2.** A scene is lit brightly and evenly, with almost no shadow. Name the style and one genre that uses it.

<details class="reveal"><summary>Show answer</summary>

**High key**. Comedy, lifestyle advertising, daytime television. Low key is the opposite: hard contrast, deep shadows, thriller and horror.

</details>

**3.** True or false: a candidate can earn marks in Section A for analysing an actor's performance.

<details class="reveal"><summary>Show answer</summary>

**False**, and this is worth remembering. The syllabus states that acting is not a skill assessed in media studies, and performance does not appear in the mise-en-scène list. Write about what was placed in the frame, not how it was played.

</details>

**4.** A character is lit from below. What does it do, and why?

<details class="reveal"><summary>Show answer</summary>

It inverts the direction light normally comes from, so the face reads as wrong before you can say why. It is the horror convention, and its power is that it breaks a rule your eye already knew.
