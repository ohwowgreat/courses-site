...
Component 2 becomes the destination. Morley explains why the same text reads differently; ownership explains why texts say what they say; and the double demystifies Section A completely by writing one with the mark scheme open on the desk. Friday opens the document the schedule promises will still be in use in May: the case-study file that A4, the End of Term Exam and Paper 2 will all draw from.
...
| Item | Date | What | AO |
|---|---|---|---|
| CS8 | Wed 2026-12-09 | Guided Section A script, mark scheme open; register-named direct practice for A4 — same format family, scaffold removed next week | AO1+AO2 |
