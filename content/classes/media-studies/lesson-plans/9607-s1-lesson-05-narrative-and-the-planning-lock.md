...
Narrative theory and production planning converge on one Wednesday: the last double before the break is where every C1 plan gets locked to the standard of the schedule's own goal line — a plan someone else could shoot without asking questions. HW1 goes out the same day because A1's 14-day notice window falls inside the holiday and cannot wait. The Friday return is the debrief: annotated, not graded, and the first hearing of the sound and editing vocabulary the shoots will now make real.
...
| LB2 | Fri 2026-10-09 | HW1 returned on time; glossary current |
 ...
 Wed 09-30. See the [[classes/media-studies/assessments/9607-s1-assessments|full register]].
