...
Representation theory is taught, then immediately weaponised against the students' own work. The week opens with A2 going in and closes, after the truncated W10, with two standalone sessions where the rough cuts are screened as an audience would see them and audited for the stereotypes their makers did not notice. The theory earns its place by finding real problems while there is still production time to fix them.
...
- **D5 (Mon 11-02, standalone):** rough-cut screening under audience conditions — no introductions, no apologies, the work speaks alone; structured response cards completed while watching.
- **D6 (Tue 11-03, standalone):** stereotype audit of their own product using the week's full toolkit (construction, positions, power, absence); **LB3 posted**; fix list drafted.
