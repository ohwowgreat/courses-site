...
This lesson closes the Component 1 arc and begins audience theory. The Wednesday double is your last chance for help before submission, so it is spent on CCR surgery. On Friday you submit the portfolio, with no edits after. The two days that follow apply uses and gratifications to your own media consumption and turn your returned portfolio into one production target for Semester 2.

## How it runs

- **D1–2 (Mon+Tue block):** mass, niche and target audiences mapped onto three real texts; day 2 — effects models stated and their limits, including what they cannot explain about your own viewing.
- **D3 (Wed, double):** brief audiences application, then **CCR surgery** — you work on your named weakest part while the teacher circulates; submission checklist run at the close.
...
- **D5 (Mon, single):** Blumler and Katz — the four gratifications mapped onto your own weekly media use, honestly logged.
- **D6 (Tue, single): A3 returned** — self-assessment against C1 criteria before marks discussed; write and log one production target (**LB4**) today for Wed 12-16.
