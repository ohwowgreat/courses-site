...
<figure class="plate plate--hero">
  <img src="../../../static/img/mark-making.jpg" alt="Peter Paul Rubens, Anatomical Studies, pen and ink, c. 1605" />
...
- **Studio 1 (25 min)** — *Drawing Exercises 4*, the traced-hand sheet: trace your hand, give each finger a different texture, following the sheet's how-to notes. Fast, funny, and it forces five distinct mark decisions.
...
- **Close (10 min)** — **announce A1 and CS1**, in plain terms: what A1 is (one final observational drawing plus a short written reflection, made in class W4–W5), what it is marked on (**observation, tone, composition**), and what CS1 checks next week (the four exercise pieces: contour work, the value scale/tonal study, texture, negative space). Post both on MB.

## Assessment

**A1** (Wed 2026-09-30) and **CS1** (Wed 2026-09-23) are announced today — 14 days and 7 days ahead respectively, both clear of the notice rules. Today's texture grid and negative-space study complete the CS1 set. Register: [[classes/pre-a-level-art-design/assessments/pal-s1-assessments|PAL S1 Assessments]].
