...
The semester ends the way every unit did: by choosing. Four finals, a term of process, forty-plus sketchbook pages — this double is for turning that into **one organized portfolio that argues you can see**, and for handing over the book that proves how you got there. Selection and sequence, one last time, at semester scale.
...
- **What a portfolio argues (10 min)** — a portfolio is not a folder, it is a claim with evidence: **4–5 strongest works**, each with self-chosen supporting material (intention, reflections, sketches, tests, process photos — no single required formula), in **one clearly organized PDF or slide file**. Choose what represents you, not what took longest.
...
- **A5: the sketchbook (15 min)** — final pages settled, name on the spine, a paper slip marking the page you're proudest of. Books are collected here: the fifth attainment, marked on **ideas, experimentation, visual research, reflection, presentation**.
